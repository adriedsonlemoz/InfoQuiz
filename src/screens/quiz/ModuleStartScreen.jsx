...
export default function ModuleStartScreen({ data, setPlayerData, setScreen, gameConfig, setGameConfig, setAlertModal }) {
    ...
    return (
        <Box mt={3} textAlign="center">
            ...
            {progress && (
                <Paper sx={{p:2, mb:3, bgcolor:'#0b131c', border:'1px solid #1e3a5f'}}>
            ...
            <Paper sx={{p: 0.5, display:'flex', gap:1, mb:4, bgcolor: '#000'}}>
            ...
            <Paper sx={{ p:2, mb:4, bgcolor: '#0b131c', borderLeft: '4px solid #00bcd4', textAlign: 'left' }}>
